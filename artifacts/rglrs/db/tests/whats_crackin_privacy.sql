...
do $$ begin
 if not public.can_view_live_location(auth.uid(),'e1000000-0000-0000-0000-000000000002') then raise exception 'friend audience denied accepted friend'; end if;
 if public.can_view_live_location(auth.uid(),'e1000000-0000-0000-0000-000000000003') then raise exception 'friend audience exposed stranger'; end if;
end $$;
...
do $$ begin
 if public.can_view_live_location(auth.uid(),'e1000000-0000-0000-0000-000000000002') then raise exception 'person-specific location denial did not win'; end if;
end $$;
...
do $$ declare v_row record; begin
 ...
 if v_row.pin_id is null or not v_row.is_anonymous or v_row.user_id is not null or v_row.display_name is not null or v_row.avatar_upload_id is not null then
...
do $$ begin
 if public.can_view_live_location(auth.uid(),'e1000000-0000-0000-0000-000000000002') then raise exception 'stopped sharing remained visible'; end if;
end $$;
reset role;
rollback;
